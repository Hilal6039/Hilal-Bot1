...
const cuttweet = [
    ...
    '‏كت تويت | كيف تتعامل مع الاش��اص السلبيين ؟',
...
.then(collected =>{ 
  ...
  .catch(collected => message.channel.send(`**السكوت علامة ا��رضا نقول قلللوش مبروك**`))
...
const secre = [
 ...
 "**لو خيروك بين 5 ملايين دولار أو 5 ملايين لحظ�� سعادة حقيقيةا**.", 
...
if(!msg.channel.guild) return msg.reply('**:x: اسف لكن هذا الامر للسيرفرات ف��ط **');         
const embed = new Discord.RichEmbed();
                ...
                jimp.read(url, (err, ava) => {
                    ...
                    ava.getBuffer(jimp.MIME_PNG, (err, buf) => {
                     ...
                     ctx.drawImage(ava, 8, 43, 80, 85); // احداثيات صورتك
                        ...
                        ctx.fillText(`${getvalueof.username}`, 130, 125) // ��حداثيات اسمك          
