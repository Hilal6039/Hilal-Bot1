...
client.on('ready', () => {                           
client.user.setGame(`!help |!invite |!support`,'https://www.youtube.com/kinggamer_th3');                                                                                                                                                                                                                                                                                                                                                                                                                            
});
...
client.on("message", message => {
 if (message.content === "!help-public") {
  const embed = new Discord.RichEmbed()
	  ...
	  .addField('❖-|!profile', `🆔يجبلك الملف الشخصي حقك🆔`)
	  ...
	  .addField('❖-|!say', `🎆البوت يكرر الكلام الي انت تقوله بدون امبد📝`)
  	  ...
  	  .addField('❖-|!users1', `🎆يعرض لك جميع السيرفرات ا الموجودة بلبوت📝`)
    ...
    message.channel.send({
        embed: new Discord.RichEmbed()
            ...
            .addField('``My ID``' , `[ ${client.user.id} ]` , true)
                  ...
                  .setFooter('By |<@352832614190809089>')
    })
}
});
...
👑Commands KinGBoT|أوامر البوت الأسطورية👑
...
if(message.content.startsWith(prefix + 'brc')) {
